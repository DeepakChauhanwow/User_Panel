...
export class ProfileComponent implements OnInit, OnDestroy {
  ...
  constructor(private _commonService: CommonService, private modalService: BsModalService, public _helper: Helper, private _documentService: DocumentService, private _paymentService: PaymentService, private cd: ChangeDetectorRef, private _notifierService: NotifiyService, private _socket: SocketService, private route: ActivatedRoute) { }
